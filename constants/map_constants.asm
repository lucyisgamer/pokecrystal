...
DEF CHUNK_SIZE EQU 16
DEF NUM_MAP_GROUPS EQU const_value ; 26
DEF MAP_CHUNK_WIDTH EQU 64 ; how many chunks wide the map is
DEF CHUNK_HEADER_SIZE EQU 8
DEF CHUNK_HEADER_SIZE_LOG2 EQU 3
DEF NUM_CHUNK_HEADERS_ROWS_IN_BANK EQU 16384 / (CHUNK_HEADER_SIZE * MAP_CHUNK_WIDTH)
	RSRESET
DEF CHARBLOCK_BANK RB 1
DEF CHARBLOCK_POINTER_IN_BANK RW 1
DEF TILEMAP_BANK RB 1
DEF TILEMAP_POINTER RW 1
